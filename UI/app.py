...
def gen():
    ...
    while(cap.isOpened()):
        ...
        if success == True:
            ...
            #convert remove single-dimensional entries from the sh ape of an array
...
# docker run --env="DISPLAY" --volume="/tmp/.X11-unix:/tmp/.X11-unix:rw" --decdvice="/dev/video0:/dev/video0" yolov5